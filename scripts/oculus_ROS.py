...
"""
os.environ['ROS_MASTER_URI'] = 'http://192.168.130.23:11311/'
os.environ['ROS_IP'] = '192.168.130.30'
"""

os.environ['ROS_MASTER_URI'] = 'http://192.168.0.140:11311/'
os.environ['ROS_IP'] = '192.168.0.196'
...
if __name__ == "__main__":
  rospy.init_node('oculus_ori')
  global pub
  pub=rospy.Publisher('/oculus_ori', geo.Pose, queue_size=1)
...
#    print desc.ProductName
    ...
    if ts.StatusFlags & (Status_OrientationTracked | Status_PositionTracked):
        ...
        pub_do = geo.Pose()
        pub_do.orientation.x = ichikawa_x
        pub_do.orientation.y = ichikawa_y
        pub_do.orientation.z = ichikawa_z
        pub_do.orientation.w = ichikawa_w
